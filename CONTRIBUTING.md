...
Ready to contribute?
Here's how to set up `requests_oauth2client` for local development.
...
1. When you're done making changes, check that your changes pass the tests, including testing other Python versions,
   with tox:
...
1. The pull request should work for Python 3.10+ and for PyPy.
